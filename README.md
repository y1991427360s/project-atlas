...
一个只读扫描本地项目目录的 Windows 桌面工具。按“年份 → 月份 → 项目”展示目录，并提供可拖动项目画布、搜索、统计、收藏、最近打开和项目排除功能。
...
“项目画布”使用大括号展示“总览 → 年份 → 月份 → 项目”关系。年份和月份可以分别展开或收起，展开状态会自动保存；按住画布空白区域即可自由拖动，工具栏中的定位按钮可回到起点。
